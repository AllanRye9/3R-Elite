...
export default function Footer() {
  return (
    <footer className="bg-gray-900 text-gray-400 hidden md:block">
      {/* Main footer content */}
            ...
            <div className="flex gap-2">
              {[
                ...
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="w-8 h-8 rounded-lg bg-gray-800 hover:bg-brand-600 flex items-center justify-center text-xs transition-colors interactive"
                >
                  {s.icon}
                </a>
              ))}
